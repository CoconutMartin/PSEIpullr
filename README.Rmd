...
The plot_performance() function allows quick plotting of the portfolio, with the portfolio_tracker() function performing some basic analyses of the portfolio. 
